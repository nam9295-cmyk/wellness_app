...
const styles = StyleSheet.create({
  ...
  caption: { ...atelierText.summary, color: atelierColors.textMuted, fontSize: 14, lineHeight: 22, marginBottom: spacing.xl },
  sectionCaption: { ...atelierText.helper, fontSize: 13, marginBottom: spacing.sm, color: atelierColors.textSoft },
